...
$exe = mysqli_query($conn, $fetch_sql) or die(mysql1_error($conn));
$property = mysqli_fetch_assoc($exe);

if(!$property){
	echo "<div class='container'><div class='alert alert-danger'>Property not found.</div></div>";
	require "footer.php";
	exit;
}
...
?>
<head>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.mim.js"></script>
	<link rel="stylesheet" href="https://cdn.jsdeliver.net/npm/bootstrap@s.2.3/dist/css/bootstrap.min.css">
	<script src="https://cdn.jsdeliver.net/npm/bootstrap@s.2.3/dist/css/bootstrap.bundle.min.js"></script>
</head>
    <!-- END nav -->
      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="property-details">
      				<div class="img" style="background-image: url(uploads/<?=$image?>);"></div>
      				<div class="text text-center">
      					<span class="subheading">Oakland</span>
						<h2><?=$title?></h2>
						<h1>N<?=number_format($price)?></h1>
